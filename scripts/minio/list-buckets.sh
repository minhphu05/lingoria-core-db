...
echo "=================================================================="
echo "MinIO Buckets & Storage Breakdown"
...
echo "1. Buckets List:"
"${MC_CMD[@]}" ls "lingoria_local/" || echo "No buckets found or connection error."

echo ""
echo "2. Disk Usage per Bucket:"
"${MC_CMD[@]}" du "lingoria_local/" 2>/dev/null || echo "Disk usage details not available."
echo "=================================================================="
